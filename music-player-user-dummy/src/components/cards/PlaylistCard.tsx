  ...
  return (
    ...
    >
      <div className="relative aspect-square rounded-md overflow-hidden mb-3">
        <img src={playlist.coverUrl || "/placeholder.svg"} alt={playlist.title} className="w-full h-full object-cover" loading="lazy" />
      ...
      <p className="text-xs text-muted-foreground truncate">{playlist.description || `${playlist.trackCount} tracks`}</p>
    </motion.div>
  );
}
